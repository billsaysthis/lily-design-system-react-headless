...
//
// A box area that looks like a smart watch. Renders a decorative <div> container that
...
export interface MockupWatchProps {
    className?: string;
...
export default function MockupWatch({
    className = "",
    children,
    ...restProps
}: MockupWatchProps) {
    return (
        <div
            className={`mockup-watch ${className}`}
            {...restProps}
        >
            {children}
        </div>
