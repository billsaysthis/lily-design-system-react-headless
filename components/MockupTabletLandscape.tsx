...
//
// A box area that looks like a tablet computer in landscape mode. Renders a decorative <div> container that
...
export interface MockupTabletLandscapeProps {
    className?: string;
...
export default function MockupTabletLandscape({
    className = "",
    children,
    ...restProps
}: MockupTabletLandscapeProps) {
    return (
        <div
            className={`mockup-tablet-landscape ${className}`}
            {...restProps}
        >
            {children}
        </div>
