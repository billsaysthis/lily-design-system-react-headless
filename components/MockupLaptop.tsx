...
//
// A box area that looks like a laptop computer. Renders a decorative <div> container that
...
export interface MockupLaptopProps {
    className?: string;
...
export default function MockupLaptop({
    ...
    return (
        <div
            className={`mockup-laptop ${className}`}
            {...restProps}
        >
            {children}
        </div>
