...
//
// A permanent hyperlink for a Digital Object Identifier (DOI) to an electronic source. Renders as a semantic <a> element with
...
export interface DigitalObjectIdentifierLinkProps {
    className?: string;
...
export default function DigitalObjectIdentifierLink({
    className = "",
    href,
    label = undefined,
    children,
    ...restProps
}: DigitalObjectIdentifierLinkProps) {
    return (
        <a
            className={`digital-object-identifier-link ${className}`}
            href={href}
            aria-label={label}
            {...restProps}
        >
