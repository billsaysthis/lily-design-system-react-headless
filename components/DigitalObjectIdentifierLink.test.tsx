...
import Subject from "./DigitalObjectIdentifierLink";
...
describe("DigitalObjectIdentifierLink", () => {
    ...
    test("applies class digital-object-identifier-link", () => {
        render(<Subject href="/x">Click</Subject>);
        const link = screen.getByRole("link");
        expect(link.getAttribute("class")).toContain("digital-object-identifier-link");
    });
