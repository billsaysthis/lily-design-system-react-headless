...
//
// A box area that looks like a tablet computer in portrait mode. Renders a decorative <div> container that
...
export interface MockupTabletPortraitProps {
    className?: string;
...
export default function MockupTabletPortrait({
    className = "",
    children,
    ...restProps
}: MockupTabletPortraitProps) {
    return (
        <div
            className={`mockup-tablet-portrait ${className}`}
            {...restProps}
        >
            {children}
        </div>
